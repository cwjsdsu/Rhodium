...
!  integer(8),parameter :: maxpiecedimdefault = 4000000000_8   ! uses 1 Gb under normal defaults
   integer(8) :: maxpiecedimdefault = 50000000   ! uses 1 Gb under normal defaults
   integer :: minpiece = 10000     ! suggested minimum size for pieces; if too small then inefficient
